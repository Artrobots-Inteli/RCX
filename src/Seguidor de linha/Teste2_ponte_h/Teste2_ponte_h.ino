...
void loop()
{
  ...
  //Drive both motors CW
  motorDrive(motor1, turnCW, 128);
  motorDrive(motor2, turnCW, 128);
 
  //Keep driving for 1 secs
  delay(450);
